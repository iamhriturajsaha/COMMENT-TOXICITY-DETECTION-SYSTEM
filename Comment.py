...
Original file is located at
    https://colab.research.google.com/drive/1jrD-pOUAyaGJ1FFuHUoo0y71ioZ-S-Sf
"""
...
# ===============================
    ...
    if uploaded_file is not None and model and vectorizer:
        ...
        if "comment" in df.columns:
            ...
            st.write(df["clean_comment"].head())

            X_input = vectorizer.transform(df["comment"].astype(str).tolist())
            ...
            st.error("❌ CSV must have a 'clean_comment' column!")
